      ...
      <section className="bg-white border-t">
        <div className="max-w-7xl mx-auto px-4 py-16 sm:py-20 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Premium Quality', desc: 'Professionally printed on archival-quality paper that lasts generations.' },
              { title: 'Beautiful Templates', desc: 'Curated designs for every occasion - weddings, travel, baby, and more.' },
              { title: 'Secure Payments', desc: 'Pay safely with Razorpay. Your payment information is always protected.' },
              { title: 'Fast Delivery', desc: 'Get your album delivered to your doorstep across India.' },
            ].map((f) => (
      ...
      <section className="bg-indigo-600">
        <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16 text-center">
          ...
          <p className="text-indigo-100 mb-8">
            Start preserving your memories today. It only takes a few minutes.
          </p>
          <Link
            to={user ? '/templates' : '/register'}
            className="inline-block bg-white text-indigo-600 px-8 py-3 rounded-lg font-semibold hover:bg-indigo-50 transition text-lg"
          >
